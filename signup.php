...
<body style="font-family: tahoma; background-color: #e9ebee;">
    ...
    <div id="login_bar">
        Sign up to my book<br><br>
        <form method="post" action="">

            <input value="<?php echo $first_name ?>" name="first_name" type="text" id="text"
                placeholder="First name"><br><br>
            <input value="<?php echo $last_name ?>" name="last_name" type="text" id="text"
